...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    fixes: [
      ...
      'With no browser listeners connected (RadioDJ or VLC on the relay only) the console\'s Stats panel showed dashes; it now shows this console\'s upload rate and round trip to the server, and says so. WebRTC figures clear when the last browser listener leaves instead of freezing on stale numbers',
